...
public class RetrofitUtils {
    ...
    public void doPost(String uri, HashMap<String,String> params,final  RetrofitCallback callback){
        RetrofitService service=retrofit.create(RetrofitService.class);
        service.postReg(uri,params).enqueue(new Callback<ResponseBody>() {
            @Override
